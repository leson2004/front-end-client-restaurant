      ...
      <nav className="  navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
        <NavLink to="/" className="navbar-brand p-0 d-flex align-items-center">
          <img
            ...
            className="mr-2"
          />
          <h3 className="ff-secondary text-start text-primary fw-normal m-0">
            Hương Việt
          </h3>
        </NavLink>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
          <div className="navbar-nav m-auto py-0 pe-4">
            <NavLink
              to="/"
          ...
          <NavLink
            to="/booking"
            className="btn btn-primary btn-sm rounded py-2 px-4 ms-1 me-1"
            // style={{ color: "black" }}
          >
            Đặt bàn
          </NavLink>
          {user ? (
            ...
            <NavLink
              to="/login"
              className="btn btn-primary btn-sm rounded py-2 px-4 ms-1"
              // style={{ color: "black" }}
            >
