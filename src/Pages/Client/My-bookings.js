  ...
  const addTable = async (reservationID, reservationDate, depositAmount) => {
    try {
      ...
      const response = await http.post(
        "http://localhost:8080/api/reservations_t_admin/addTable",
        {
          reservationID,
          reservationDate,
        },
        ...
        {!getUserIdFromToken() ? (
          ...
          <>
            ...
            {reservationState.reservation &&
              reservationState.reservation.map((booking, index) => {
                ...
                return (
                  <div className="card mb-3 shadow-sm" key={booking.id}>
                    ...
                    <div className="card-body">
                      <div className="row">
                        <div
                          className="col-md-8 col-sm-12 d-flex flex-wrap"
                          style={{ gap: "10px" }}
                        >
